...
# print('╔════════════════════════════════')
# if i % 6 == 0 and i >= 0:
#     print(f'║ Количество журавликов, сделанных Петей: {i // 6}.')
#     print(f'║ Количество журавликов, сделанных Катей: {4 * i // 6}.')
#     print(f'║ Количество журавликов, сделанных Серёжей: {i // 6}.')
# else:
